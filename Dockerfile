...
RUN /usr/share/kibana/bin/kibana-plugin install https://github.com/floragunncom/search-guard-kibana-plugin/releases/download/v5.2.2-alpha/searchguard-kibana-alpha-5.2.2.zip
